...
public class CarTest {
    ...
    public void testEqualsIdenticalCars() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
    ...
    public void testEqualsDifferentName() {
        Car car1 = new Car(new Text("BMW M3"),      2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("Toyota Camry"), 2021, 290.0f, 4.2f, 4);
    ...
    public void testEqualsDifferentYear() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("BMW M3"), 2019, 290.0f, 4.2f, 4);
        Assert.assertFalse(car1.equals(car2));
    }
    ...
    public void testEqualsDifferentTopSpeed() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("BMW M3"), 2021, 300.0f, 4.2f, 4);
        Assert.assertFalse(car1.equals(car2));
    }
    ...
    public void testEqualsDifferentAcceleration() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("BMW M3"), 2021, 290.0f, 5.0f, 4);
        Assert.assertFalse(car1.equals(car2));
    }
    ...
    public void testEqualsDifferentDoors() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Car car2 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 2);
        Assert.assertFalse(car1.equals(car2));
    }
    ...
    public void testEqualsDifferentObject() {
        Car car1 = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
        Assert.assertFalse(car1.equals(new Object()));
    }

    @Test
    public void testToStringContainsName() {
        Car car = new Car(new Text("BMW M3"), 2021, 290.0f, 4.2f, 4);
